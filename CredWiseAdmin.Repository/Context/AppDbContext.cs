    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LoanBankStatement>(entity =>
        {
            ...
            entity.HasOne(d => d.VerifiedByNavigation).WithMany(p => p.LoanBankStatements)
                .HasConstraintName("FK__LoanBankS__Verif__17036CC0");
        });
        ...
        modelBuilder.Entity<LoanProductDocument>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.IsActive).HasDefaultValue(true);
            entity.HasOne(d => d.LoanApplication).WithMany(p => p.LoanProductDocuments)
                .HasConstraintName("FK__LoanProdu__LoanA__17F790F9");
        ...
        modelBuilder.Entity<LoanRepaymentSchedule>(entity =>
        {
            ...
            // Explicitly configure RepaymentId as identity column
            entity.Property(e => e.RepaymentId)
                  .ValueGeneratedOnAdd()
                  .UseIdentityColumn(); // For SQL Server
